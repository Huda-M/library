<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-[#e0f0ff] to-[#c2e0ff] py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md p-10 shadow-xl bg-white/90 rounded-2xl backdrop-blur-md animate-fade-in">
            <div>
            ...
            <form method="POST" action="{{ route('login') }}" class="mt-8 space-y-6">
                ...
                <!-- Email Address -->
                <div>
                    <x-input-label for="email" :value="('Email')" class="font-semibold text-black" />
                ...
                <!-- Password -->
                <div>
                    <x-input-label for="password" :value="('Password')" class="font-semibold text-black" />
