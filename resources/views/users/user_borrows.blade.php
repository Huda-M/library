<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
            {{ __('Borrows for') }} {{ $user->first_name }} {{ $user->last_name }}
        </h2>
    </x-slot>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase dark:text-gray-300">Actual Return</th>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                @if($borrow->book && $borrow->book->photo)
                                                    <img src="{{ Storage::url($borrow->book->photo) }}" alt="{{ $borrow->book->name }}" class="object-cover w-10 h-10 rounded">
                                                @else
                    ...
                    <div class="mt-6">
                        <a href="{{ route('users.index') }}" class="px-4 py-2 font-semibold text-white bg-blue-500 rounded hover:bg-blue-600">
                            <i class="mr-1 fas fa-arrow-left"></i> Back to Users
                        </a>
                    </div>
                </div>
            </div>
