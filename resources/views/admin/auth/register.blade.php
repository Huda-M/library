<x-guest-layout>
    <form method="POST" action="{{ route('admin_register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="address" class="block w-full mt-1" type="address" name="address" :value="old('address')" required autocomplete="address" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block w-full mt-1" type="phone" name="phone" :value="old('phone')" required autocomplete="phone" />
            <x-input-error :messages="$errors->get('phone')" class="mt-2" />
        </div>

        <div class="mt-4">
            <x-input-label for="photo" :value="__('photo')" />
            <x-text-input id="photo" class="block w-full mt-1" type="file" name="photo" :value="old('photo')" required autocomplete="photo" />
